...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findItemByText(long userId, String text) {
    ...
    public ResponseEntity<Object> createComment(long userId, long itemId, NewCommentRequest commentRequest) {
        return post("/" + itemId + "/comment", userId, commentRequest);
    }

    public ResponseEntity<Object> updateItem(long userId, long itemId, UpdateItemRequest itemRequest) {
